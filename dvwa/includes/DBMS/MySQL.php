...
$avatarUrl  = $base_dir . 'hackable/users/admin.jpg';

$insert = "INSERT INTO users VALUES
	('1','admin','admin','admin',MD5('password'),'{$avatarUrl}', NOW(), '0'),
	('2','Gordon','Brown','gordonb',MD5('abc123'),'{$avatarUrl}', NOW(), '0'),
	('3','Hack','Me','1337',MD5('charley'),'{$avatarUrl}', NOW(), '0'),
	('4','Pablo','Picasso','pablo',MD5('letmein'),'{$avatarUrl}', NOW(), '0'),
	('5','Bob','Smith','smithy',MD5('password'),'{$avatarUrl}', NOW(), '0'),
	('6','Anirudh','Mitta','anirudh',MD5('mypass'),'{$avatarUrl}',NOW(),'0');";
